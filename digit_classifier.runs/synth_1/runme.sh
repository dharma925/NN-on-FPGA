...
HD_PWD='C:/Users/Dharma/Desktop/InternPreps/Projects/NN/FPGA/digit_classifier/digit_classifier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log softmax.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source softmax.tcl
